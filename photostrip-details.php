...
<p><span>Product size  <i class=" glyphicon glyphicon-arrow-right"></i> <?php echo rtrim($productSize,'<br/>');?>  </span></p>

<h4>Starting at Rs. <?=$productStartingPrice?></h4>

<a href="<?=DEFAULT_URL?>/photostrip_upload/<?=$finalSlug?>">ORDER NOW <i class="glyphicon glyphicon-check"></i></a>
